...
END
  ...
  def test_obt_source
    ...
    assert_equal 'subst_prop', words[0][:pos]
    assert_equal '.', words[1][:form]
    assert_equal '$.', words[1][:lemma]
    assert_equal '<punkt>', words[1][:pos]
